...
export const siteComponentCatalogTools: readonly AiTool[] = Object.freeze([
  ...
  tool({ name: 'site_insert_component', description: 'Invoke the reviewed, metered, audited component-usage capability; direct database, server, credential, and scope authority are unavailable.', action: 'insert', schema: InsertDataBackedSectionInputSchema, mutates: true, capabilities: ['site.structure.edit'], mcpCapability: 'component.mutate' }),
