...
/**
 * Ticket-owned additive migration contribution. The conductor must allocate the
 * final sequential ID and register its checksum; this worker does neither.
 */
export const publicTemplateReleasesMigration: HostedMigration = {
  id: '000055_public_template_releases',
  ...
  sql: `
    ...
    before update on fuma_public_template_releases
