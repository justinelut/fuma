...
export async function createHostedPublicationRuntime(input:Readonly<{db:DbClient;config:FumaConfig;objectAccessSigningSecret:string;now?:()=>Date}>):Promise<HostedPublicationRuntime>{
