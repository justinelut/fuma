...
const SRC_DIR = join(STUDIO_ROOT, 'src')
const VENDOR_ICONS_DIR = join(WORKSPACE_ROOT, 'vendor/pixel-art-icons/icons')
const VENDOR_DIST_ICONS_DIR = join(
  WORKSPACE_ROOT,
  'vendor/pixel-art-icons/dist/icons',
)
const VENDOR_TYPES_FILE = join(WORKSPACE_ROOT, 'vendor/pixel-art-icons/types.ts')
