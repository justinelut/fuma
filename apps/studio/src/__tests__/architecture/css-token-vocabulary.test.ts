...
const STUDIO_ROOT = join(SRC_ROOT, '..')
...
const DOC_FILES = [
  join(WORKSPACE_ROOT, 'docs/design.md'),
  join(WORKSPACE_ROOT, 'docs/reference/design-tokens.md'),
  join(WORKSPACE_ROOT, 'docs/reference/ui-primitives.md'),
]
