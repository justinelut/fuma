...
const STUDIO_ROOT = join(process.cwd(), 'apps/studio')
...
describe('ContentPage', () => {
  ...
  it('does not delay admin navigation or use route changes to collapse workspace panels', async () => {
    ...
    const layoutSource = readFileSync(join(STUDIO_ROOT, 'src/admin/layouts/AdminCanvasLayout/AdminCanvasLayout.tsx'), 'utf8')
  ...
  it('does not fade or view-transition the central canvas surface during admin navigation', () => {
    const layoutCss = readFileSync(join(STUDIO_ROOT, 'src/admin/layouts/AdminCanvasLayout/AdminCanvasLayout.module.css'), 'utf8')
  ...
  it('renders the post title as a wrapping multi-line editor', async () => {
    ...
    const contentCss = readFileSync(join(STUDIO_ROOT, 'src/admin/pages/content/ContentPage.module.css'), 'utf8')
  ...
  it('uses Tiptap for the body editor and serialises to markdown on update', () => {
    const src = readFileSync(join(STUDIO_ROOT, 'src/admin/pages/content/TiptapBodyEditor.tsx'), 'utf8')
  ...
  it('uses the content publish button as the single published-state indicator', () => {
    const src = readFileSync(join(STUDIO_ROOT, 'src/admin/pages/content/components/ContentToolbar/ContentToolbar.tsx'), 'utf8')
