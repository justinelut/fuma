...
const SEGMENTED_CONTROL_CSS = join(
  STUDIO_ROOT,
  'src/ui/components/SegmentedControl/SegmentedControl.module.css',
)
const RANGE_TABS_CSS = join(STUDIO_ROOT, 'src/ui/components/RangeTabs/RangeTabs.module.css')
const BUTTON_CSS = join(STUDIO_ROOT, 'src/ui/components/Button/Button.module.css')
const CANVAS_MODE_TOGGLE_CSS = join(
  STUDIO_ROOT,
  'src/admin/pages/site/canvas/CanvasModeToggle.module.css',
)
const SECTION_CSS = join(STUDIO_ROOT, 'src/ui/components/Section/Section.module.css')
