...
- **Web application**: Next.js, tRPC, and Better Auth
- **Database**: PostgreSQL accessed through Drizzle
- **Object storage**: MinIO or another S3-compatible service
- **Coordination**: Redis for consumers that require cross-replica state
- **Sandbox provider**: CodeSandbox for editable project environments
