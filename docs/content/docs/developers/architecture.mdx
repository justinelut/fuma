...
Onlook is a Bun monorepo built around a Next.js web application, Better Auth, PostgreSQL accessed through Drizzle, S3-compatible object storage, TailwindCSS, and isolated project sandboxes.
...
├── apps/
│   └── web/
│       └── client/                # Next.js application and tRPC API
│
├── packages/
...
│   └── code-provider/             # Sandbox provider abstraction
│
