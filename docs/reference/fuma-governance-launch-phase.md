...
FUMA-063, FUMA-064, and FUMA-065 are conductor-finalized in the existing Studio AI architecture. Hosted migrations `000063_ai_catalog_authority`, `000066_ai_credits_authority`, and `000068_site_ai_scope_authority` are centrally registered at checksums `218a40b70d8774a4774bc9b0b5c9b5ffe002b8b793ba87c067e88f7a92682ec8`, `9de088d429ae82927f92145d191851f99dd98a92f5c852a0a64f0e6a43796517`, and `0c0368622abc603c03cd46e2c37107c2efc61c38f1bb3335539efcffa1e77bd5`. Native composition declares `ai-credits` plus the `site-ai` runtime scope, `fuma.ai-credit-expiry`, and collision-free BYOK transfer order 615. Exact actor/session/editor/site/profile/owner-generation authority, snapshot hashes, replay-safe tools, actual settlement, revocation, secret-free persistence, focused and native PostgreSQL acceptance are complete without a parallel runner/store/provider/bridge. FUMA-066 and FUMA-SITE-008 remain dependent extensions of this one AI/MCP runtime. FUMA-076 remains conductor-finalized through the bounded Lawyer adapter and finalized generic Ghost/payment authorities; it required no new migration and its complete inventory, quarantine, reauthentication, OCI Email Delivery and Paystack evidence-reconciliation gates pass.
