...
- **052 Metering/COGS:** `metering/service.ts` records logical+physical reservation/settlement, immutable attribution, amplification classes, internal shadow cost, provider reconciliation and fail-closed stale/missing cost inputs.
